...
function draw_grid()
  ...
  local week_num_start = year_margin+box_width/2-pt2in(16)
  local week_num_space = box_width + pt2in(7)
  ...
  for year = 0, years do
    ...
    for week = 1, 52 do
      local date_string = ""
      if print_dates then
        date_string = string.format([[\rlap{\smash{\tiny\scalefont{0.5} %s}}]], getWeekDates(start + year, week))
      end
