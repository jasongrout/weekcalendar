...
function draw_grid()
  ...
  -- Font size heights in points (approximate, for 10pt base)
  local font_heights = {
    ["\\tiny"] = 6,
    ["\\scriptsize"] = 8,
    ["\\footnotesize"] = 9,
  ...
  local week_num_height = font_heights[week_num_size] or 20 -- default to LARGE if not found
  local header_space = pt2in(week_num_height + 4) -- font height + vskip (2pt) + some padding
